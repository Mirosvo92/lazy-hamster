...
export function Thread() {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    const content: Message["content"] = imageDataUrl
      ? [
            ...
            footer={
              <div className="sticky flex flex-col items-center gap-8 bottom-0 bg-white">
                ...
                <div className="bg-muted rounded-2xl border shadow-xs mx-auto mb-8 w-full max-w-3xl relative z-10">
                  ...
                  >
                    {imageDataUrl && (
                      <div className="relative w-20 h-20 m-3 mb-0">
                        <img
                          src={imageDataUrl}
                          alt="attachment"
                        ...
                        <button
                          ...
                          className="absolute -top-1.5 -right-1.5 bg-white rounded-full border shadow-sm p-0.5"
                        >
                          <X className="w-3 h-3" />
                        </button>
                      </div>
